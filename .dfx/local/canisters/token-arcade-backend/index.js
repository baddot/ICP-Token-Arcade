...
import { idlFactory } from './token-arcade-backend.did.js';
export { idlFactory } from './token-arcade-backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_TOKEN_ARCADE_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./token-arcade-backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the token-arcade-backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./token-arcade-backend.did.js")._SERVICE>}
 */
export const token_arcade_backend = createActor(canisterId);
