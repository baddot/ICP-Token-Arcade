...
import { idlFactory } from './token-arcade-frontend.did.js';
export { idlFactory } from './token-arcade-frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_TOKEN_ARCADE_FRONTEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./token-arcade-frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the token-arcade-frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./token-arcade-frontend.did.js")._SERVICE>}
 */
export const token_arcade_frontend = createActor(canisterId);
